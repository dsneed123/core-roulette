...
const Workout = () => {
  ...
  const allGifs = [
    ...
    { src: './../media//Inter./../media/te/Band-Assisted-Wheel-Rollouts.gif', name: 'Band-Assisted Wheel Rollouts', instruction: 'Kneel and roll a wheel away from you while keeping your core tight.' },
    { src: './../media//Inter./../media/te/Bicycle-Crunch.gif', name: 'Bicycle Crunch (Inter./../media/te)', instruction: 'Perform a bicycle crunch, focusing on your core and controlling the movement.' },
    { src: './../media//Inter./../media/te/Captains-Chair-Leg-Raises.gif', name: 'Captain’s Chair Leg Raises', instruction: 'Use a captain’s chair and lift your legs to engage your abs.' },
    { src: './../media//Inter./../media/te/Decline-Weighted-Situp.gif', name: 'Decline Weighted Situp', instruction: 'Perform a situp on a decline bench with added weight for resistance.' },
    { src: './../media//Inter./../media/te/Hanging-Flutter-Kicks.gif', name: 'Hanging Flutter Kicks', instruction: 'Hang from a bar and alternate kicking your legs up and down.' },
    { src: './../media//Inter./../media/te/Hanging-Knee-Raises.gif', name: 'Hanging Knee Raises', instruction: 'Hang from a bar and bring your knees towards your chest.' },
    { src: './../media//Inter./../media/te/lying-leg-raise.gif', name: 'Lying Leg Raise (Inter./../media/te)', instruction: 'Lie flat and raise your legs, keeping them straight to work your lower abs.' },
    { src: './../media//Inter./../media/te/Russian-Twists.gif', name: 'Russian Twists', instruction: 'Sit on the floor, lean back slightly, and twist your torso side to side.' },
    { src: './../media//Inter./../media/te/Weighted-Crunch.gif', name: 'Weighted Crunch', instruction: 'Perform a crunch while holding a weight plate for added resistance.' },
    { src: './../media//Inter./../media/te/Weighted-Knee-Raises-Captains-Chair.gif', name: 'Weighted Knee Raises (Captain’s Chair)', instruction: 'Use a captain’s chair and lift your knees while holding weights.' },
