...
const Workout = () => {
  ...
  const allGifs = [
    ...
    { src: '././media/Intermediate/Bicycle-Crunch.gif', name: 'Bicycle Crunch (Intermediate)', instruction: 'Perform a bicycle crunch, focusing on your core and controlling the movement.' },
    ...
    { src: '././media/Intermediate/lying-leg-raise.gif', name: 'Lying Leg Raise (Intermediate)', instruction: 'Lie flat and raise your legs, keeping them straight to work your lower abs.' },
